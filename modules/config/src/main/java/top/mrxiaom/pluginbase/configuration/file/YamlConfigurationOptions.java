 ...
 * top.mrxiaom.pluginbase.configuration.file.YamlConfiguration}
 */
public class YamlConfigurationOptions extends FileConfigurationOptions {
    private int indent = 2;
    private int width = 80;

    protected YamlConfigurationOptions(@NotNull top.mrxiaom.pluginbase.configuration.file.YamlConfiguration configuration) {
        super(configuration);
    }

    @NotNull
    @Override
    public top.mrxiaom.pluginbase.configuration.file.YamlConfiguration configuration() {
