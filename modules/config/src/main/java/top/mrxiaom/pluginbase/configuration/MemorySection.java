...
public class MemorySection implements ConfigurationSection {
    ...
    private final top.mrxiaom.pluginbase.configuration.Configuration root;
    private final ConfigurationSection parent;
    private final String path;
    private final String fullPath;

    /**
     * Creates an empty MemorySection for use as a root {@link top.mrxiaom.pluginbase.configuration.Configuration}
     * section.
     * <p>
     * Note that calling this without being yourself a {@link top.mrxiaom.pluginbase.configuration.Configuration}
     * will throw an exception!
     *
     * @throws IllegalStateException Thrown if this is not a {@link
     *     top.mrxiaom.pluginbase.configuration.Configuration} root.
     */
    protected MemorySection() {
        if (!(this instanceof top.mrxiaom.pluginbase.configuration.Configuration)) {
        ...
        this.fullPath = "";
        this.parent = null;
        this.root = (top.mrxiaom.pluginbase.configuration.Configuration) this;
    }
    ...
    public Set<String> getKeys(boolean deep) {
        ...
        top.mrxiaom.pluginbase.configuration.Configuration root = getRoot();
    ...
    @Override
    @Nullable
    public top.mrxiaom.pluginbase.configuration.Configuration getRoot() {
        return root;
    }
    ...
    public ConfigurationSection getDefaultSection() {
        top.mrxiaom.pluginbase.configuration.Configuration root = getRoot();
        top.mrxiaom.pluginbase.configuration.Configuration defaults = root == null ? null : root.getDefaults();
     ...
     * root {@link top.mrxiaom.pluginbase.configuration.Configuration}.
     * <p>
    ...
    public static String createPath(@NotNull ConfigurationSection section, @Nullable String key, @Nullable ConfigurationSection relativeTo) {
        ...
        top.mrxiaom.pluginbase.configuration.Configuration root = section.getRoot();
        if (root == null) {
