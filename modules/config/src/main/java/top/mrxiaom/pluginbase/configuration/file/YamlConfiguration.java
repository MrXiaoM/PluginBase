...
import top.mrxiaom.pluginbase.configuration.Configuration;
import top.mrxiaom.pluginbase.configuration.ConfigurationSection;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    private final top.mrxiaom.pluginbase.configuration.file.YamlConstructor constructor;
    private final top.mrxiaom.pluginbase.configuration.file.YamlRepresenter representer;
