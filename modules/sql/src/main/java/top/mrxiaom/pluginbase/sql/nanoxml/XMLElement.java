...
public class XMLElement implements Serializable {
     ...
     * <pre><code>new XMLElement(new Hashtable(), false, true)
     * </code></pre>
     *
     ...
     * Creates and initializes a new XML element.
     * Calling the construction is equivalent to:
     * <pre><code>new XMLElement(entities, false, true)
     * </code></pre>
     *
     * @param entities
     ...
     * Creates and initializes a new XML element.
     * Calling the construction is equivalent to:
     * <pre><code>new XMLElement(new Hashtable(), skipLeadingWhitespace, true)
     * </code></pre>
     *
     ...
     * Creates and initializes a new XML element.
     * Calling the construction is equivalent to:
     * <pre><code>new XMLElement(entities, skipLeadingWhitespace, true)
     * </code></pre>
     *
     * @param entities
     *     The entity conversion table.
        ...
        throws IOException
    {
        ...
        if ((this.contents != null) && (!this.contents.isEmpty())) {
            ...
            writer.write('>');
            Enumeration<XMLElement> enumeration = this.enumerateChildren();
            while (enumeration.hasMoreElements()) {
            ...
            switch (ch) {
                ...
                default:
                    if (((int) ch < 32) || ((int) ch > 126)) {
                        writer.write('&'); writer.write('#');
                        writer.write('x');
                        writer.write(Integer.toString((int) ch, 16));
                        writer.write(';');
                    } else {
                        writer.write(ch);
                    }
