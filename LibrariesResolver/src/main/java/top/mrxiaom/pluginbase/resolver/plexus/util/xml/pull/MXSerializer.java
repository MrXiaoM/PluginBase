    ...
    implements XmlSerializer
{
    ...
    {
        if ( namesInterned && !name.equals(name.intern()) )
        {
    ...
    public String getPrefix( String namespace, boolean generatePrefix )
    {
        ...
        for ( int i = namespaceEnd - 1; i >= 0; --i )
        {
            if (namespace.equals(namespaceUri[i]))
            {
                ...
                {
                    if (prefix.equals(namespacePrefix[p])) {
        ...
        if ( namespace != null )
        {
            ...
            if ( namespace.length() > 0 )
            {
                ...
                if ( depth > 0 && ( namespaceEnd - elNamespaceCount[depth - 1] ) == 1 )
                {
                    ...
                    if (uri.equals(namespace) || uri.equals( namespace ) )
                    {
                        ...
                        for ( int pos = elNamespaceCount[depth - 1] - 1; pos >= 2; --pos )
                        {
                            ...
                            if (pf.equals(elPfx) || pf.equals( elPfx ) )
                            {
                                String n = namespaceUri[pos];
                                if (n.equals(uri) || n.equals( uri ) )
                                {
        ...
        throws IOException
    {
        ...
        if (!Objects.equals(namespace, elNamespace[depth]))
        {
        ...
        if ( ( !namesInterned && !name.equals( elName[depth] ) ) || ( namesInterned && !name.equals(elName[depth])) )
        {
