...
import top.mrxiaom.pluginbase.resolver.maven.model.io.ModelParseException;
...
import top.mrxiaom.pluginbase.resolver.maven.model.path.ModelPathTranslator;
import top.mrxiaom.pluginbase.resolver.maven.model.path.ModelUrlNormalizer;
import top.mrxiaom.pluginbase.resolver.maven.model.path.ProfileActivationFilePathInterpolator;
import top.mrxiaom.pluginbase.resolver.maven.model.plugin.LifecycleBindingsInjector;
import top.mrxiaom.pluginbase.resolver.maven.model.plugin.PluginConfigurationExpander;
import top.mrxiaom.pluginbase.resolver.maven.model.plugin.ReportConfigurationExpander;
import top.mrxiaom.pluginbase.resolver.maven.model.plugin.ReportingConverter;
import top.mrxiaom.pluginbase.resolver.maven.model.profile.DefaultProfileActivationContext;
...
import top.mrxiaom.pluginbase.resolver.maven.model.resolution.WorkspaceModelResolver;
...
public class DefaultModelBuilder implements ModelBuilder {
    ...
    private DefaultProfileActivationContext getProfileActivationContext(ModelBuildingRequest request, Model rawModel) {
        ...
        userProperties.computeIfAbsent(
                ProfileActivationContext.PROPERTY_NAME_PACKAGING, (p) -> rawModel.getPackaging());
    ...
    private Model interpolateModel(Model model, ModelBuildingRequest request, ModelProblemCollector problems) {
        ...
        if (interpolatedModel.getParent() != null) {
            ...
            try {
                ...
                ModelProblemCollectorRequest mpcr = new ModelProblemCollectorRequest(ModelProblem.Severity.ERROR, ModelProblem.Version.BASE)
        ...
        if (parent != null) {
            ...
            if (parentData == null) {
                ...
                if (pomFile != null) {
                    ...
                    if ((!pomSource.equals(expectedParentSource))) {
                        parentData = readParentExternally(childModel, request, problems);
                    }
                }
            }
    ...
    private ModelSource getParentPomFile(Model childModel, ModelSource source) {
        ...
        return source.getRelatedSource(parentPath);
    }
    ...
    private ModelData readParentExternally(
        ...
        try {
            ...
            if (isNotContainsCoordinates(e.getMessage(), groupId, artifactId, version)) {
