...
package top.mrxiaom.pluginbase.resolver.http.auth.params;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link top.mrxiaom.pluginbase.resolver.http.client.config.RequestConfig}
 *   and constructor parameters of
 *   {@link top.mrxiaom.pluginbase.resolver.http.auth.AuthSchemeProvider}s.
*/
@Deprecated
public interface AuthPNames {
     ...
     * {@link top.mrxiaom.pluginbase.resolver.http.auth.Credentials}.
     * <p>
     ...
     *  {@link top.mrxiaom.pluginbase.resolver.http.auth.AuthScheme}s when authenticating with
     *  the target host.
     * <p>
     ...
     * {@link top.mrxiaom.pluginbase.resolver.http.auth.AuthScheme#getSchemeName()}.
     */
    String TARGET_AUTH_PREF = "http.auth.target-scheme-pref";

    /**
     * Defines the order of preference for supported
     *  {@link top.mrxiaom.pluginbase.resolver.http.auth.AuthScheme}s when authenticating with the
     *  proxy host.
     * <p>
     * This parameter expects a value of type {@link java.util.Collection}. The
     * collection is expected to contain {@link String} instances representing
