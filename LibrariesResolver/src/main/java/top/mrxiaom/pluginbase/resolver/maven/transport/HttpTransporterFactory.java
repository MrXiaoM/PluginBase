...
import top.mrxiaom.pluginbase.resolver.maven.transport.checksum.Nexus2ChecksumExtractor;
import top.mrxiaom.pluginbase.resolver.maven.transport.checksum.XChecksumChecksumExtractor;
