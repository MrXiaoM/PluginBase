...
import top.mrxiaom.pluginbase.resolver.http.message.TokenParser;
...
public class URLEncodedUtils {
     ...
     *            Encoding to use when decoding the parameters.
     *
     * @deprecated (4.4) use {@link #parse(top.mrxiaom.pluginbase.resolver.http.util.CharArrayBuffer, java.nio.charset.Charset, char...)}
     */
    @Deprecated
    public static void parse(
            final List <NameValuePair> parameters,
    ...
    public static List<String> parsePathSegments(final CharSequence s, final Charset charset) {
        ...
        list.replaceAll(content -> urlDecode(content, charset != null ? charset : Consts.UTF_8, false));
        return list;
    }
