 ...
 * under the License.
 */
package top.mrxiaom.pluginbase.resolver.maven.model.superpom;

import top.mrxiaom.pluginbase.resolver.maven.model.InputSource;
import top.mrxiaom.pluginbase.resolver.maven.model.Model;
import top.mrxiaom.pluginbase.resolver.maven.model.building.ModelProcessor;
...
public class DefaultSuperPomProvider implements SuperPomProvider {
    ...
    public Model getSuperModel(String version) {
        if (superModel == null) {
            String resource = "/META-INF/super-pom-" + version + ".xml";
            ...
            try {
                ...
                inputSource.setLocation(url.toExternalForm());
