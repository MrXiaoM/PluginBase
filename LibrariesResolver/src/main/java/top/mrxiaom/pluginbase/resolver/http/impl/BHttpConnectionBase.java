...
import top.mrxiaom.pluginbase.resolver.http.entity.BasicHttpEntity;
import top.mrxiaom.pluginbase.resolver.http.entity.ContentLengthStrategy;
import top.mrxiaom.pluginbase.resolver.http.impl.entity.LaxContentLengthStrategy;
import top.mrxiaom.pluginbase.resolver.http.impl.entity.StrictContentLengthStrategy;
import top.mrxiaom.pluginbase.resolver.http.impl.io.ChunkedInputStream;
import top.mrxiaom.pluginbase.resolver.http.impl.io.ChunkedOutputStream;
...
import top.mrxiaom.pluginbase.resolver.http.impl.io.SessionOutputBufferImpl;
...
import top.mrxiaom.pluginbase.resolver.http.util.NetUtils;

/**
 * This class serves as a base for all {@link top.mrxiaom.pluginbase.resolver.http.HttpConnection} implementations
