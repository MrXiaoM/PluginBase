...
import top.mrxiaom.pluginbase.resolver.aether.spi.connector.checksum.ChecksumPolicy.ChecksumKind;
import top.mrxiaom.pluginbase.resolver.aether.spi.connector.layout.RepositoryLayout.ChecksumLocation;
import top.mrxiaom.pluginbase.resolver.aether.spi.io.FileProcessor;
import top.mrxiaom.pluginbase.resolver.aether.transfer.ChecksumFailureException;
...
final class ChecksumValidator {
    ...
    private boolean validateChecksums(Map<String, ?> actualChecksums, ChecksumKind kind, Map<String, ?> checksums)
        ...
        for (Map.Entry<String, ?> entry : checksums.entrySet()) {
            ...
            if (isNotEqualChecksum(expected, actual)) {
    ...
    private static boolean isNotEqualChecksum(String expected, String actual) {
