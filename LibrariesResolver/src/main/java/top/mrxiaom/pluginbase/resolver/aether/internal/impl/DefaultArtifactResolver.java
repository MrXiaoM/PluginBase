...
import top.mrxiaom.pluginbase.resolver.aether.impl.UpdateCheck;
import top.mrxiaom.pluginbase.resolver.aether.impl.UpdateCheckManager;
    ...
    private boolean isLocallyInstalled(LocalArtifactResult lar, VersionResult vr) {
        ...
        if (lar.getFile() != null) {
            ...
            if (vr.getRepository() instanceof LocalRepository) {
                ...
                return true;
            } else return vr.getRepository() == null
