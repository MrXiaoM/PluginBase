...
package top.mrxiaom.pluginbase.resolver.http;
...
public interface HttpMessage {
     ...
     *
     * @deprecated (4.3) use configuration classes provided 'top.mrxiaom.pluginbase.resolver.http.config'
     *  and 'top.mrxiaom.pluginbase.resolver.http.client.config'
     */
    @Deprecated
