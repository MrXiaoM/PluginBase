 ...
 * under the License.
 */
package top.mrxiaom.pluginbase.resolver.aether.spi.connector.checksum;
...
public interface ChecksumPolicy {
    ...
    enum ChecksumKind {
         ...
         * {@link top.mrxiaom.pluginbase.resolver.aether.spi.connector.transport.GetTask#setChecksum(String, String)}. If no included
         * checksum present, {@link #REMOTE_EXTERNAL} is tried for.
         */
        REMOTE_INCLUDED,

        /**
         * Provided checksums may be provided by ProvidedChecksumsSource components, ahead of artifact
