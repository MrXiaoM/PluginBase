 ...
 * under the License.
 */
package top.mrxiaom.pluginbase.resolver.aether.util.version;

import java.util.ArrayList;
import java.util.Collection;

import top.mrxiaom.pluginbase.resolver.aether.version.InvalidVersionSpecificationException;
import top.mrxiaom.pluginbase.resolver.aether.version.VersionScheme;
...
public final class GenericVersionScheme implements VersionScheme {
     ...
     * <pre>java -cp ${maven.repo.local}/org/apache/maven/resolver/maven-resolver-api/${resolver.version}/maven-resolver-api-${resolver.version}.jar:${maven.repo.local}/org/apache/maven/resolver/maven-resolver-util/${resolver.version}/maven-resolver-util-${resolver.version}.jar top.mrxiaom.pluginbase.resolver.aether.util.version.GenericVersionScheme "1.2.7" "1.2-SNAPSHOT"</pre>
