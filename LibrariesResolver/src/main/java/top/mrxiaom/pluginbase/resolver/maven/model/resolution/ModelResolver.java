 ...
 * under the License.
 */
package top.mrxiaom.pluginbase.resolver.maven.model.resolution;

import top.mrxiaom.pluginbase.resolver.maven.model.Parent;
import top.mrxiaom.pluginbase.resolver.maven.model.Repository;
import top.mrxiaom.pluginbase.resolver.maven.model.building.ModelBuilder;
 ...
 * {@link ModelBuilder} will add any relevant repositories to the model resolver. In
...
public interface ModelResolver {
     ...
     * clone. The only requirement is that invocations of {@link #addRepository(Repository, boolean)} on the clone do not affect
