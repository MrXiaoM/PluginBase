 ...
 * under the License.
 */
package top.mrxiaom.pluginbase.resolver.aether.spi.connector;
 ...
 * {@link top.mrxiaom.pluginbase.resolver.aether.RepositorySystemSession#getConfigProperties() configuration properties} of the repository
 ...
 *
 * @see top.mrxiaom.pluginbase.resolver.aether.spi.connector.transport.TransporterProvider
 * @see top.mrxiaom.pluginbase.resolver.aether.spi.connector.layout.RepositoryLayoutProvider
 * @see top.mrxiaom.pluginbase.resolver.aether.spi.connector.checksum.ChecksumPolicyProvider
 */
