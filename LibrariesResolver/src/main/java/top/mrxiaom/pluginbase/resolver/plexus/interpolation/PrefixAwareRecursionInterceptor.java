    ...
    implements RecursionInterceptor
{
    ...
    private final Stack<String> nakedExpressions = new Stack<>();

    private final String[] possiblePrefixes;

    private final boolean watchUnprefixedExpressions = true;
    ...
    {
        this.possiblePrefixes = possiblePrefixes.toArray(new String[0]) ;
    }
     ...
     */
    public List<String> getExpressionCycle( String expression )
    {
