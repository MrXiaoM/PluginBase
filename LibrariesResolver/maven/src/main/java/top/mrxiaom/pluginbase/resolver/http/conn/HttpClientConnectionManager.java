 ...
 *
 */
package top.mrxiaom.pluginbase.resolver.http.conn;
...
public interface HttpClientConnectionManager {
     ...
     * by calling {@link #connect(top.mrxiaom.pluginbase.resolver.http.HttpClientConnection,
     *   top.mrxiaom.pluginbase.resolver.http.conn.routing.HttpRoute, int,
     *   top.mrxiaom.pluginbase.resolver.http.protocol.HttpContext) connect} in order to connect
     * directly to the target or to the first proxy hop, optionally calling
     * {@link #upgrade(top.mrxiaom.pluginbase.resolver.http.HttpClientConnection,
     *   top.mrxiaom.pluginbase.resolver.http.conn.routing.HttpRoute,
     *   top.mrxiaom.pluginbase.resolver.http.protocol.HttpContext) upgrade} method to upgrade
     ...
     *  top.mrxiaom.pluginbase.resolver.http.HttpClientConnection,
     *  top.mrxiaom.pluginbase.resolver.http.conn.routing.HttpRoute,
     *  top.mrxiaom.pluginbase.resolver.http.protocol.HttpContext) routeComplete} to mark the route
     *  as fully completed.
     * </p>
     *
