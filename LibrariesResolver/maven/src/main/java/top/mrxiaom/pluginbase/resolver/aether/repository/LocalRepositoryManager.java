 ...
 * under the License.
 */
package top.mrxiaom.pluginbase.resolver.aether.repository;
 ...
 * @see top.mrxiaom.pluginbase.resolver.aether.RepositorySystem#newLocalRepositoryManager(RepositorySystemSession, LocalRepository)
 */
