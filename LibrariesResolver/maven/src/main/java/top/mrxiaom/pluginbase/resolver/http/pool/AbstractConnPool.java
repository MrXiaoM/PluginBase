 ...
 *
 */
package top.mrxiaom.pluginbase.resolver.http.pool;
...
import top.mrxiaom.pluginbase.resolver.http.concurrent.FutureCallback;
...
public abstract class AbstractConnPool<T, C, E extends PoolEntry<T, C>>
    ...
    public Future<E> lease(final T route, final Object state, final FutureCallback<E> callback) {
        ...
        return new Future<E>() {
            ...
            @Override
            public E get(final long timeout, final @NotNull TimeUnit timeUnit) throws InterruptedException, ExecutionException, TimeoutException {
                for (;;) {
                    synchronized (this) {
                        try {
