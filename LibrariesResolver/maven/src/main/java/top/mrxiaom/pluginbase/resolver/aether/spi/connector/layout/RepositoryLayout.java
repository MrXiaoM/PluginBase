 ...
 * under the License.
 */
package top.mrxiaom.pluginbase.resolver.aether.spi.connector.layout;
...
public interface RepositoryLayout {
     ...
     *
     * @see top.mrxiaom.pluginbase.resolver.aether.spi.connector.checksum.ChecksumPolicy.ChecksumKind
     * @since 1.8.0
     */
     ...
     * {@link top.mrxiaom.pluginbase.resolver.aether.spi.connector.checksum.ChecksumPolicy.ChecksumKind#REMOTE_EXTERNAL}.
     * On download, the {@link top.mrxiaom.pluginbase.resolver.aether.spi.connector.layout.RepositoryLayout#getChecksumAlgorithmFactories()}
